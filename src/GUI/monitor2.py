...
class monitor_window(QtWidgets.QDialog, ui_monitor.Ui_window):
    ...
    def __init__(self):
        ...
        self.p = self.win.addPlot(colspan=2)                     #p是一张图
        ...
        self.win1.setWindowTitle('MAx sum Plots')                          
        self.p2 = self.win1.addPlot(colspan=2)                     #p是一张图
        self.p2.setLabel('bottom', 'Time', 's')
        self.p2.setXRange(-10, 0)                          
        self.Tsum_curves1 = []
        self.thre_curves2=[]
